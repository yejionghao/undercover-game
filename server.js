...
const WORD_PAIRS = {
  2: [
    ...
    ['老虎', '狮子'], ['飞机', '火车'], ['汽车', '摩托'], ['雨伞', '雨衣'],
    ['钢笔', '铅笔'], ['椅子', '凳子'], ['袜子', '手套']
  ],
  3: [
    ['麦当劳', '肯德基'], ['冰激凌', '棒棒糖'], ['向日葵', '蒲公英'],
    ['草莓酱', '蓝莓酱'], ['小米粥', '南瓜粥'], ['运动鞋', '登山鞋'],
    ['太阳镜', '老花镜'], ['充电宝', '移动硬'], ['咖啡杯', '茶叶罐'],
    ['滑板车', '自行车'], ['保温杯', '玻璃杯'], ['跑步机', '椭圆机']
  ],
  4: [
    ['阿里巴巴', '京东商城'], ['北京烤鸭', '广州叉烧'],
    ['珍珠奶茶', '抹茶拿铁'], ['圣诞老人', '复活兔子'],
  ...
  5: [
    ['故宫博物院', '国家博物馆'], ['星巴克咖啡', '瑞幸咖啡店'],
    ['健身房会员', '游泳馆会员'], ['巧克力饼干', '奥利奥夹心']
  ]
};

// 分组规则
function getGroupSizes(total) {
  // [A组平民数, B组平民数, 卧底数]，支持 6-12 人
  const rules = {
    6:  [2, 2, 2],
    7:  [2, 3, 2],
    8:  [2, 3, 3],
